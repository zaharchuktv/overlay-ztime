...
src_install() {
cd ${WORKDIR}
mkdir -p ${D}/usr/share/linuxbuh
mkdir -p ${D}/usr/share/linuxbuh/bx
mkdir -p ${D}/usr/share/linuxbuh/doc
...
cp -r ${WORKDIR}/INSTALL ${D}/usr/share/linuxbuh
cp -r ${WORKDIR}/doc/*.txt ${D}/usr/share/linuxbuh/doc
cp -r ${WORKDIR}/bx/*.alx ${D}/usr/share/linuxbuh/bx
