...
CALC_URI="ftp://ftp.calculate.ru/pub/calculate/calculate-sources/calculate-sources-${CL_PATCH}.tar.bz2
        ftp://ftp.calculate-linux.org/pub/calculate/calculate-sources/calculate-sources-${CL_PATCH}.tar.bz2
		http://mirror.yandex.ru/calculate/calculate-sources/calculate-sources-${CL_PATCH}.tar.bz2
		ftp://ftp.linux.kiev.ua/pub/Linux/Calculate/calculate-sources/calculate-sources-${CL_PATCH}.tar.bz2"

SRC_URI="${KERNEL_URI} ${ARCH_URI} ${CALC_URI} ${HGPV_URI}"

UNIPATCH_LIST="${DISTDIR}/calculate-sources-${CL_PATCH}.tar.bz2"
